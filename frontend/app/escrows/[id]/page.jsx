  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'a',
          { href: getStellarExpertUrl(escrow.counterparty), target: '_blank', rel: 'noopener' },
          'Counterparty',
        ),
        ' | ',
        React.createElement(
          'a',
          { href: getStellarExpertUrl(escrow.client), target: '_blank', rel: 'noopener' },
          'Client',
        ),
      ),
    ),
