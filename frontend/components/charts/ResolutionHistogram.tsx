...
export const ResolutionHistogram: React.FC<ResolutionHistogramProps> = ({ data, isLoading, isError }) => {
      ...
      <div className="flex-1 min-h-[250px]">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
            ...
            <XAxis dataKey="bucket" tick={{fontSize: 12, fill: '#64748b'}} tickLine={false} axisLine={false} />
